...
<section>
    ...
    <hr/>
    <a href="mealForm"><spring:message code="meals.AddMeal"/></a>
    <hr/>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr data-mealExceed="${meal.exceed}">
                ...
                <td>${meal.calories}</td>
                <td><a href="mealForm?id=${meal.id}"><spring:message code="meals.Update"/></a></td>
                <td><a href="mealDelete?id=${meal.id}"><spring:message code="meals.Delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
