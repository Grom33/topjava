...
public class MealRestControllerTest extends AbstractControllerTest {
    ...
    public void testCreate() throws Exception {
        ...
        assertMatch(mealService.getAll(USER_ID), Arrays.asList(returned, MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1));
    ...
    public void getFiltered() throws Exception {
        mockMvc.perform(get(REST_URL + "filter?startDate=2015-05-30T10:00:00&startTime=2015-05-30T10:00:00&endDate=2015-05-31T20:00:00&endTime=2015-05-31T20:00:00"))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(contentJson(MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1));
